...
if __name__ == '__main__':
    ...
    # Load the best policy if it exists, along with the highest reward
    highest_reward = qlearn.load_best_reward("QValues")
    qlearn.loadQ("QValues")  # Comment out if you want to start fresh every time
